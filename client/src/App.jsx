...
function App() {
  ...
  useEffect(() => {
    ...
    const shouldBeDark =
      !savedTheme || theme === "dark" || savedTheme === "dark";
  ...
  const handleCloseOnboarding = () => {
    ...
    // No localStorage tracking - modal will show again on next visit
  };
    ...
    >
      ...
      <Routes>
        ...
        <Route
          path="/login"
          element={
            !isAuthenticated ? <Login /> : <Navigate to="/gigs" replace />
          }
        />
        <Route
          path="/register"
          element={
            !isAuthenticated ? <Register /> : <Navigate to="/gigs" replace />
          }
        />
        <Route
